...
Ok, alguns conceitos apareceram, mas não precisamos ficar assustados. Iremos entende-los com o tempo e com a prática. Para começar a nossa jornada dentro do __R__, vamos nos dedicar a entender as estruturas de dados mais utilizadas dentro dele. Estruturas de dados são formas de guardar informação. No R, embora existam outras, temos duas estruturas de dados muito importantes: os vetores e os _data frames_.
...
```{r, echo = FALSE, fig.width=8.0, fig.height=7.0}
...
```{r, echo = FALSE, fig.width=8.0, fig.height=5.0}
...
Vamos checar algumas variáveis. Decidimos não reclassificá-las, mas caso deseje você pode transformá-las de acordo com o critério que preferir, substituindo os valores dos códigos anteriores.
