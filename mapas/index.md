...
## Source: "/home/rafael/Documents/Curso_R_Sociais/material/tu.mapas/rmsp", layer: "MunRM07"
## with 39 features
## It has 8 fields
...
```
## Error in left_join_impl(x, y, by_x, by_y, aux_x, aux_y, na_matches): Can't join on 'COD_IBGE' x 'COD_IBGE' because of incompatible types (integer / factor)
```
