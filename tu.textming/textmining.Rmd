...
Esse exemplo foi retirado de um site de marketing, mas esclarece exatamente o que é uma stopword

```{r}
tokens(discursos$discourse, remove_numbers = T, remove_punct = T,
